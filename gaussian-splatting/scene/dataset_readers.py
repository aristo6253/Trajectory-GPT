...
def readHandcraftedCameras(trajectory_file):
    ...
    for idx, cam in enumerate(camera_list):
        uid = cam.get("id", idx)
        image_name = cam.get("img_name", f"cam_{uid:04d}")
        image_path = ""  # blank or inferred elsewhere
        ...
        # Use fx, width to compute horizontal FoV
...
sceneLoadTypeCallbacks = {
    ...
    "Trajectory": readTrajectorySceneInfo
}